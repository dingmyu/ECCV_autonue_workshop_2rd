...
def get_args():
    ...
    parser.add_argument('--gts', default="/mnt/lustre/sunpeng/Research/image-base-workshop/anue/gtFine/val/")
    parser.add_argument('--preds', default="")
    parser.add_argument('--txt_address', default="val.txt")
...
def main(args):
    ...
    gts     = []
    preds   = []
    for line in open(args.txt_address).readlines():
